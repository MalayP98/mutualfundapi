...
public class PaymentController {
    ...
    public String createPaymentLink(@RequestHeader("user-phone") String userPhone, @RequestBody Map<String, Object> paymentRequest) {
        //Get User
        ...
        */
        ...
        try {
            ...
            String[] keys = {"accountNumber", "ifscCode","amount","redirectUrl"};
            Map<String, Object> requestBody = new HashMap<>();

            for(String key: keys) {
                if( !paymentRequest.containsKey(key)) throw new Exception("Missing parameter "+key);
                else {
                    Object value =paymentRequest.get(key);
                    if(value == null) throw new Exception("Null  Value not allowed for parameter "+key);
